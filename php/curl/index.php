...
$data = ['url' => 'https://storage.googleapis.com/api4ai-static/samples/wine-3.jpg'];
...
// Parse response and print probabilities.
echo join('',
          ["\n💬 Probabilities: \n",
           json_encode($raw_response['results'][0]['entities'][0]['classes'], JSON_PRETTY_PRINT),
           "\n"]);
?>
